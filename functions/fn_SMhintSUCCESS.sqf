...
"<t align='center'><t size='2.2'>Neben Mission</t><br/><t size='1.5' color='#08b000'>COMPLETE</t><br/>____________________<br/>Erstklassige Leistung! Die OPFOR kontrollierten Gebiete auf der Insel werden nicht lange in deren Hand bleiben, wenn Sie so weiter machen!<br/><br/>Auf Grund von Gebietseroberungen gewähren Wir Ihnen eine Verstärkung. %1 befindet sich in der Basis.<br/><br/>Konzentrieren Sie sich weiter auf das Hauptziel. Wir übermitteln Ihren Erfolg an das Operationszentrum und prüfen ob es weitere Aufträge in Ihrem Einsatzgebiet gibt. Sie erhalten in 15 - 30 Minuten Nachricht über neue Angriffskoordinaten.</t>",_vehName];
...
showNotification = ["reward", format["Ihre Gruppe erhält %1!", _vehName]]; publicVariable "showNotification";
