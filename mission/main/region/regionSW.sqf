...
while { count _targetArray > 0 } do {
	...
	_radioTowerDownText = "<t align='center' size='2.2'>Radio Tower</t><br/><t size='1.5' color='#08b000' align='center'>DESTROYED</t><br/>____________________<br/>Der feindliche Funkturm wurde zerstört, Fantastische Arbeit, Männer!<br/><br/><t size='1.2' color='#08b000' align='center'> Der Feind kann keine kommunikation mehr aufbauen!</t><br/>";
