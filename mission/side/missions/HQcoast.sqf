...
//-------------------- BRIEFING
	...
	sideMarkerText = "Sichern Sie die geschmuggelten Sprengstoffe"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Neben Mission: Sichern Sie die geschmuggelten Sprengstoffe";
	publicVariable "sideMarker";
	publicVariable "sideObj";
			
	_c4Message = ["Der Zünder wurde eingestellt! 30 Sekundeden bis zur der Detonation","Der C4 Zünder ist eingestellt! 30 Sekunden bis zur der Detonation","Der Zünder wurde eingestellt! 30 Sekundeden bis zur der Detonation"] call BIS_fnc_selectRandom;

	_briefing = "<t align='center'><t size='2.2'>Neue Neben Mission</t><br/><t size='1.5' color='#00B2EE'>Sichern Sie die geschmuggelten Sprengstoffe</t><br/>____________________<br/>OPFOR Kräfte haben in Küstennähe in einem Mobilen HQ Explosive Schmuggelware versteckt.<br/><br/>Wir haben das Gebäude auf der Karte markiert. Verlegen Sie dort hin und sichern Sie die Lieferung. Halten Sie genug Abstand beim sprengen. Da ist ne Menge Zeug drin.</t>";
	GlobalHint = _briefing; publicVariable "GlobalHint"; hint parseText GlobalHint;
	showNotification = ["NewSideMission", "Sichern Sie die geschmuggelten Sprengstoffe"]; publicVariable "showNotification";
	sideMarkerText = "Sichern Sie die geschmuggelten Sprengstoffe"; publicVariable "sideMarkerText";
