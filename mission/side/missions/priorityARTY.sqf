...
//-------------------- 5. SPAWN FORCE PROTECTION
	...
	priorityTargetText = "Zerstören Sie die Artillerie!"; publicVariable "priorityTargetText";
	"priorityMarker" setMarkerText "Prioritätsziel: Zerstören Sie die Artillerie!"; publicVariable "priorityMarker";

	_briefing = "<t align='center' size='2.2'>Prioritätsziel</t><br/><t size='1.5' color='#b60000'>Zerstören Sie die Artillerie!</t><br/>____________________<br/>OPFOR Kräfte nehmen eine Luftabwehr Batterie in Betrieb! Wir haben die Koordinaten mit Hilfe von Thermalbildern aufgeklärt und auf Ihrer Karte markiert.<br/><br/>Das ist ein Prioritätsziel! Es wird grade besetzt, Sie werden in fünf Minuten Feuerbereit sein!";
	GlobalHint = _briefing; hint parseText _briefing; publicVariable "GlobalHint";
	showNotification = ["NewPriorityTarget", "Zerstören Sie die Artillerie!"]; publicVariable "showNotification";

	_firingMessages = [
		"Wir haben mit Hilfe von Thermalbildern feindlichen Artilleriebeschuss aufgeklärt! Gehen Sie in Deckung!",
		"Achtung Feindlicher Artilleriebeschuss! Suchen Sie sofort Deckung!",
		"OPFOR Artilleriebeschuss! Suchen Sie Deckung!",
		"Wir liegen unter Feuer einer feindlichen Artilleriestellung! In Deckung!",
		"Zerstören Sie umgehend die feindliche Artilleriestellung! Achtung Beschuss! Deckung!",
		"Feindlicher Artilleriebeschuss kommt näher! Sofort in Deckung!"
	];
...
_completeText = "<t align='center' size='2.2'>Prioritätsziel</t><br/><t size='1.5' color='#08b000'>NEUTRALISIERT</t><br/>____________________<br/>Gute Arbeit, Männer! Stellen Sie einen schnellen Absprung auf die Prioritätsziele sicher!<br/><br/>Greifen Sie weiter das Hauptziel an. Wir werden Uns bei neuer Auftragslage melden.";
GlobalHint = _completeText; hint parseText _completeText; publicVariable "GlobalHint";
showNotification = ["CompletedPriorityTarget", "Feindliche Artillerie wurde zerstört!"]; publicVariable "showNotification";
