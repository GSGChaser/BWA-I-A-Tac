...
_c4Message = ["Nachschubkiste gesichert. Die Ladungen sind scharf! Detonation in 30 Sekunden.","Waffenfund gesichert. Sprengstoff wurde aktiviert! 30 Sekunden bis zur Detonation.","Nachschub von Aufständischen gesichert. Die Ladungen sind scharf! Detonation in 30 Sekunden."] call BIS_fnc_selectRandom;
...
//-------------------- SPAWN BRIEFING
	...
	sideMarkerText = "Sichern Sie den Nachschub der Aufständischen"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Neben Mission: Sichern Sie den Nachschub der Aufständischen"; publicVariable "sideMarker";
	publicVariable "sideObj";
	
	_briefing = "<t align='center'><t size='2.2'>Neue Neben Mission</t><br/><t size='1.5' color='#00B2EE'>Sichern Sie den Nachschub der Aufständischen</t><br/>____________________<br/>OPFOR trainiert einen Aufständischen auf Altis.<br/><br/>Wir haben die Position auf der Karte markiert.Verlegen Sie ins Einsatzgebiet, säubern Sie den Bereich und sichern Sie den Nachschub.</t>";
	GlobalHint = _briefing; hint parseText GlobalHint; publicVariable "GlobalHint";
	showNotification = ["NewSideMission", "Sichern Sie den Nachschub der Aufständischen"]; publicVariable "showNotification";
	sideMarkerText = "Sichern Sie den Nachschub der Aufständischen"; publicVariable "sideMarkerText";
