...
//-------------------- BRIEF
	...
	sideMarkerText = "Sichern Sie den Helikopter"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Neben Mission: Sichern Sie den Helikopter"; publicVariable "sideMarker";
	publicVariable "sideObj";

	_briefing = "<t align='center'><t size='2.2'>Neue Neben Mission</t><br/><t size='1.5' color='#00B2EE'>Sichern Sie den feindlichen Helikopter!</t><br/>____________________<br/>OPFOR Einheiten haben einen Prototyp Angriffshelikopter zur Verfügung und verwahren Ihn in einem Hangar irgendwo auf der Insel.<br/><br/> Wir haben die Koordinaten eines vermuteten Hangar auf Ihrer Karte markiert;Stossen Sie in das Gebiet vor, sichern Sie die Unterlagen und zerstören Sie den Heliokopter.</t>";
	GlobalHint = _briefing; hint parseText _briefing; publicVariable "GlobalHint";
	showNotification = ["NewSideMission", "Sichern Sie den Helikopter"]; publicVariable "showNotification";
	sideMarkerText = "Sichern Sie den Helikopter"; publicVariable "sideMarkerText";
...
while { sideMissionUp } do {
	...
	if (!alive sideObj) exitWith {
		...
		hqSideChat = "Prototypen Information verloren! Mission FEHLGESCHLAGEN!"; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
