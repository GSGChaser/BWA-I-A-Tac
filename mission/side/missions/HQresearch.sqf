...
//-------------------- BRIEF
	...
	sideMarkerText = "Gelangen Sie in den Besitz der Forschungsdaten!"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Neben Mission: Gelangen Sie in den Besitz der Forschungsdaten!"; publicVariable "sideMarker";
	publicVariable "sideObj";
	
	_briefing = "<t align='center'><t size='2.2'>Neue neben Mission</t><br/><t size='1.5' color='#00B2EE'>Gelangen Sie in den Besitz der Forschungsdaten!</t><br/>____________________<br/>Aktuell führen OPFOR Einheiten Militärische Forschungen auf Altis durch.<br/><br/>Finden Sie die Daten und erobern Sie dieses Zielgebiet!</t>";
	GlobalHint = _briefing; publicVariable "GlobalHint"; hint parseText GlobalHint;
	showNotification = ["NewSideMissionFileData", "Gelangen Sie in den Besitz der Forschungsdaten!"]; publicVariable "showNotification";
	sideMarkerText = "Gelangen Sie in den Besitz der Forschungsdaten!"; publicVariable "sideMarkerText";
