...
_blackVehicles = ["B_Heli_Light_01_armed_F","O_Heli_Light_02_unarmed_F",
"O_Heli_transport_04_bench_F","B_Heli_Transport_01_F","B_Heli_Transport_03_F",
"B_Heli_Light_01_F","I_Heli_Transport_02_F","B_Truck_01_covered_F","I_Heli_light_03_dynamicLoadout_F","I_Plane_Fighter_03_AA_F"];									// black skin
...
_uav = ["B_T_UAV_03_dynamicLoadout_F","B_UAV_02_CAS_F","B_UAV_02_dynamicLoadout_F","B_UAV_02_F","B_UGV_01_rcws_F","B_UGV01_F","B_UAV_05_F"];									// UAVs
