...
if ((count enemyCasArray) < _jetLimit) then {
	...
	[_jetActual,_jetPilot] spawn {
		...
		showNotification = ["EnemyJet","Feindliches Kampflugzeug im Anflug!"]; publicVariable "showNotification";
		...
		showNotification = ["EnemyJetDown","Feindliches Kampflugzeug wurde zestört. Gute Arbeit!"]; publicVariable "showNotification";
