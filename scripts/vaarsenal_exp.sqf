...
[box, true] call ace_arsenal_fnc_initBox;
	...
	[box, [
		...
		"G_Tactical_Clear","O_NVGoggles_ghex_F","O_NVGoggles_hex_F","O_NVGoggles_urb_F","tf_fadak",
		"tf_pnr1000a",
		...
		"B_Messenger_Olive_F","B_Messenger_Black_F","B_Messenger_IDAP_F","B_rhsusf_B_BACKPACK",
		...
		"B_UAV_06_medical_backpack_F","C_UAV_06_backpack_F","C_UAV_06_medical_backpack_F","tf_mr6000l",
		...
		"U_C_Protagonist_VR","U_Competitor","U_C_Scientist",
		...
		"H_HelmetLeaderO_oucamo","H_Bandanna_surfer_grn","H_Bandanna_surfer_blk",
	...
	[box, player] call ace_arsenal_fnc_openBox;
	
	//end

	//Quartermaster1
	[box1, true] call ace_arsenal_fnc_initBox;
	[box1, [
		// items
        "NVGogglesB_blk_F","NVGogglesB_grn_F","NVGogglesB_gry_F",
        "optic_Nightstalker","optic_tws","optic_tws_mg","optic_DMS_ghex_F","optic_LRPS_ghex_F",
	...
	//Laptop USS Freedom
	[box2, true] call ace_arsenal_fnc_initBox;
	[box2, [
		// items
        "NVGogglesB_blk_F","NVGogglesB_grn_F","NVGogglesB_gry_F",
        "optic_Nightstalker","optic_tws","optic_tws_mg","optic_DMS_ghex_F","optic_LRPS_ghex_F",
	...
	[box2, player] call ace_arsenal_fnc_openBox;
	//end

	//Helipiloten
	[box3, true] call ace_arsenal_fnc_initBox;
	[box3, [
		// items
        "NVGogglesB_blk_F","NVGogglesB_grn_F","NVGogglesB_gry_F",
        "optic_Nightstalker","optic_tws","optic_tws_mg","optic_DMS_ghex_F","optic_LRPS_ghex_F",
	...
	[box3, player] call ace_arsenal_fnc_openBox;
	//end
