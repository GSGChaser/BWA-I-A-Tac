...
//-------------------- BRIEF
	...
	sideMarkerText = "Sichern Sie die Radarstation!"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Neben Mission: Sichern Sie die Radarstation!"; publicVariable "sideMarker";
	publicVariable "sideObj";

	_briefing = "<t align='center'><t size='2.2'>Neue Neben Mission</t><br/><t size='1.5' color='#00B2EE'>Sichern Sie die Radarstation!</t><br/>____________________<br/>OPFOR Kräfte haben eine kleine Radarstation eingenommen um Ihre Luftstreitkräfte zu unterstützen.<br/><br/>Wir haben Ihnen neue Koordinaten geschickt - Sichern Sie in das Gebiet, finden und zerstören Sie die Aufzeichnungen.</t>";
	GlobalHint = _briefing; hint parseText _briefing; publicVariable "GlobalHint";
	showNotification = ["NewSideMissionRadar", "Sichern Sie die Radarstation!"]; publicVariable "showNotification";
	sideMarkerText = "Sichern Sie die Radarstation!"; publicVariable "sideMarkerText";
...
while { sideMissionUp } do {
	...
	if (!alive sideObj) exitWith {
		...
		hqSideChat = "Information zerstört! Mission FEHLGESCHLAGEN!"; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
