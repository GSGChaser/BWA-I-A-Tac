...
Script_Verification_Objet_Attacher =
{
...

	{
...

		{
			...
			if (_x in ["Land_Pod_Heli_Transport_04_bench_F","Land_Pod_Heli_Transport_04_covered_F","Land_Pod_Heli_Transport_04_medevac_F"]) exitwith {_objet_Verifier = true;};
...
Script_Verification_Pod =
{
...

	{
		...
		if (_x in ["Land_Pod_Heli_Transport_04_bench_F","Land_Pod_Heli_Transport_04_covered_F","Land_Pod_Heli_Transport_04_medevac_F"]) exitwith {_pod_Verifier = true;};
	} foreach _liste_Class_Parent;
...
Script_Taru_Desarrimer_Pod =
{
...

	{
...

		{
			...
			if (_x in ["Land_Pod_Heli_Transport_04_bench_F","Land_Pod_Heli_Transport_04_covered_F","Land_Pod_Heli_Transport_04_medevac_F"]) exitwith {_objet_Arrimer_Egal_Pod = true;};
		} foreach _liste_Class_Parent;
